      ...
      <img className='waterbg' src={water} alt="Water Background" />
        ...
        <div className='faq-body'>
          <p className='faq-blurb'>
            Have a question that isn't answered here? <br></br>
          ...
          <p className="faq-questions">
            Of course! We regularly post photos of our hard work on the Fullard Boat Co <a id='facebook-link' href="https://www.facebook.com/FullardBoats" target="_blank" rel="noopener noreferrer"><u>Facebook</u></a> and <a id='instagram-link' href="https://www.instagram.com/fullardboatco/" target="_blank" rel="noopener noreferrer"><u>Instagram</u></a> pages.
          </p>
